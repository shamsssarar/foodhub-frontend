      ...
      <main className="container mx-auto px-4 py-10">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-white rounded-xl border">
            ...
            <p className="text-muted-foreground mt-2">Go to the menu and eat something!</p>
          </div>
        ) : (
                      ...
                      <div key={item.id} className="flex justify-between items-center">
                        <div className="flex items-center gap-4">
                          <div className="h-12 w-12 bg-gray-100 rounded-md overflow-hidden">
                             ...
                             <img src={item.meal.imageUrl || "/placeholder.png"} className="object-cover h-full w-full opacity-80" />
                          </div>
                          <div>
